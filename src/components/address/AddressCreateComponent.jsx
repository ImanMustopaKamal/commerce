...
import { postAddressRequested } from "@/store/reducers/slice/address/addressSlice";
...
function AddressCreateComponent() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      ...
      await dispatch({
        type: postAddressRequested.toString(),
        payload: payload,
      });
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Box sx={{ marginBottom: "1rem", width: "100%" }}>
            ...
            {/* <ToggleButtonGroup
              ...
              aria-label="Primary Toggle Button Group"
            >
            ...
            {/* <Button
              ...
              size="medium"
              variant="outlined"
              color={values.isPrimary ? "secondary" : "info"}
            >
              {`${
                values.isPrimary
                  ? "Make as Non Primary Address"
